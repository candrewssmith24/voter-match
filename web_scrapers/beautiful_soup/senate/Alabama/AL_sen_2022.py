...
def scrape_candidates_and_urls(election_url):
    ...
    general_election_heading = soup.find('h5', string="General election for U.S. Senate Alabama")
...
def scrape_campaign_themes(candidate_url):
    ...
    try:
        ...
        campaign_2022 = soup.find('span', {'id': '2022_2'})
        if not campaign_2022:
            print(f"No '2022' campaign section found for {candidate_url}.")
            return {}
...
def main():
    election_url = "https://ballotpedia.org/United_States_Senate_election_in_Alabama,_2022"
    ...
    # Save Word document
    output_file = "2022_US_senate_AL_candidate_stances.docx"
