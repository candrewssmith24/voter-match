...
def get_candidate_urls(url):
    ...
    for table in tables:
        for a_tag in table.find_all('a', href=True):
            ...
            if '_presidential_campaign,_2020' in candidate_url.lower() and 'staff' not in candidate_url.lower():
...
def main():
    base_url = 'https://ballotpedia.org/Presidential_candidates,_2020'
